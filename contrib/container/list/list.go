...
func (l *List[V]) insertValue(v any, at *Element[V]) *Element[V] {
...
func (l *List[V]) PushFront(v any) *Element[V] {
	l.lazyInit()
	return l.insertValue(v, &l.root)
}

// PushBack inserts a new element e with value v at the back of list l and returns e.
func (l *List[V]) PushBack(v any) *Element[V] {
	l.lazyInit()
...
func (l *List[V]) InsertBefore(v any, mark *Element[V]) *Element[V] {
	if mark.list != l {
		return nil
	}
...
// If mark is not an element of l, the list is not modified.
// The mark must not be nil.
func (l *List[V]) InsertAfter(v any, mark *Element[V]) *Element[V] {
	if mark.list != l {
		return nil
	}
	// see comment in List.Remove about initialization of l
